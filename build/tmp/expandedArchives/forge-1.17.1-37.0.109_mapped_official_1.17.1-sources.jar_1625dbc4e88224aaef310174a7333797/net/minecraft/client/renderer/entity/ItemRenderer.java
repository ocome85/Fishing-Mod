...
public class ItemRenderer implements ResourceManagerReloadListener {
   ...
   public void renderGuiItemDecorations(Font p_115175_, ItemStack p_115176_, int p_115177_, int p_115178_, @Nullable String p_115179_) {
      if (!p_115176_.isEmpty()) {
         ...
         if (p_115176_.getItem().showDurabilityBar(p_115176_)) {
            RenderSystem.disableDepthTest();
            RenderSystem.disableTexture();
            RenderSystem.disableBlend();
            Tesselator tesselator = Tesselator.getInstance();
            BufferBuilder bufferbuilder = tesselator.getBuilder();
            double health = p_115176_.getItem().getDurabilityForDisplay(p_115176_);
            int i = Math.round(13.0F - (float)health * 13.0F);
            int j = p_115176_.getItem().getRGBDurabilityForDisplay(p_115176_);
